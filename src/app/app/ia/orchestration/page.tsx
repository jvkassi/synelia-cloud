...
export default function Orchestration() {
  ...
  const enregistrer = (e: EtapeFlux[]) => setArbres((a) => ({ ...a, [courant.id]: e }))
            ...
            <div className="flex items-start justify-between gap-2">
              <span className="min-w-0">
                ...
                <span className="block truncate text-[11px] text-g-500">
                  {f.declencheur.libelle} · {f.declencheur.detail}
                </span>
              </span>
            ...
            <div className="mt-3 grid grid-cols-3 gap-2 border-t border-g-100 pt-2.5">
              <span className="block">
                ...
                <span className="tnum block text-[12.5px] font-semibold text-ink">
                  {f.executions7j > 0 ? num(f.executions7j) : '—'}
                </span>
              </span>
              <span className="block">
              ...
              <span className="block">
                <MicroLabel>Étapes</MicroLabel>
                <span className="tnum block text-[12.5px] font-semibold text-ink">
                  {toutesLesEtapes(f.etapes).length}
                </span>
              </span>
            </div>
          </button>
