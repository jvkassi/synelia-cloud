    ...
    <div className="space-y-5">
      ...
      {onglet === 'catalogue' && (
        <div className="space-y-4">
          <Callout ton="violet" titre="Les six conditions de la mention « certifiée »">
            ...
            <DataTable<InstanceParc>
              ...
              colonnes={[
                    ...
                    return (
                      <span className="flex items-center gap-2">
                        ...
                        <span className="min-w-0">
                          ...
                          <span className="block truncate text-[11px] text-g-500">{i.orgNom}</span>
                        </span>
                      </span>
                    )
                  },
                ...
                },
                {
                  ...
                  cle: (i) => i.site,
                  rendu: (i) => (
                    <span className="text-[12px] text-g-700">{SITE_COURT[i.site]}</span>
                  ),
                },
                {
                  id: 'version',
                  ...
                  cle: (i) => i.version,
                  rendu: (i) => (
                    <span className="font-mono text-[12px] text-ink">{i.version}</span>
                  ),
                },
                {
                  id: 'sieges',
                  ...
                  aligne: 'right',
                  cle: (i) => i.sieges,
                  rendu: (i) => <span className="tnum text-[12px] text-g-700">{i.sieges}</span>,
                },
                {
                  id: 'sauvegarde',
                  ...
                  {c.vagues.map((v) => (
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-[13px] font-bold text-ink">Vague {v.numero}</span>
                        {v.statut === 'terminee' ? (
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader
              ...
              sousTitre="Les neuf capacités qu’une solution doit exposer pour être certifiée. Chacune correspond à un écran du portail, et le portail ne va pas au-delà."
            />
                  ...
                  {CONTRAT_INTEGRATION.map((c) => {
                    ...
                    return (
                      <tr key={c.num} className="border-b border-g-100 last:border-0">
                        ...
                        <td className="px-3 py-2.5 text-[13px] text-ink">{c.capacite}</td>
                        <td className="px-3 py-2.5 text-[12px] text-g-700">{c.ecran}</td>
            ...
            <Callout ton="warn" className="mt-4" titre="Deux capacités ne sont pas encore couvertes partout">
              ...
              existe mais le test de réimport complet n’a pas été fait. La réversibilité n’est donc pas
              annoncée pour elles. La montée de version par vagues plafonne à 85 % pour la même raison.
            </Callout>
          </Card>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <Card>
              ...
              <ol className="space-y-2">
                {TACHES_PROVISIONING.map((t, i) => (
                  ...
                  >
                    ...
                    <span className="min-w-0 text-[13px] text-ink">{t}</span>
              ...
              <Callout ton="info" className="mt-4" titre="Idempotente veut dire rejouable">
                Une tâche rejouée sur un système déjà dans l’état attendu ne fait rien. Un
                provisionnement reprend donc à l’étape échouée, sans créer deux fois la même
                ressource.
              </Callout>
            </Card>
            ...
            <Card>
              <CardHeader
                ...
                sousTitre="Ce que le portail ne fait pas à la place de la solution."
              />
              <div className="space-y-2">
                {[
                  ...
                  <div key={x.t} className="rounded-[6px] border border-g-300 px-3 py-2.5">
                      ...
                      <td className="px-3 py-2.5">
                        <span className="flex items-center gap-2">
                          ...
                          <span className="min-w-0">
                            ...
                            <span className="block text-[11px] text-g-500">{c.solutionOSS}</span>
                          </span>
                        </span>
                      </td>
                      <td className="px-3 py-2.5">
              ...
              <div className="space-y-2">
                {fiche.paliers.map((pa) => (
                  <div key={pa.code} className="rounded-[6px] border border-g-300 px-3 py-2.5">
                    ...
                    <p className="mt-0.5 text-[12px] text-g-700">{pa.specs}</p>
              ...
              <div className="space-y-1.5">
                {fiche.parametresSpecifiques.map((x) => (
                  <div key={x.titre} className="rounded-[6px] border border-g-300 px-3 py-2">
                    ...
                    <p className="mt-0.5 text-[12px] leading-relaxed text-g-700">{x.description}</p>
                  </div>
                ))}
              </div>
            </div>
