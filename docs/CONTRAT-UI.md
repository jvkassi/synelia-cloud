...
<RpoRtoGauge libelle="RPO" cibleMin constateMin />
<SlaGauge composant engagement constate />
<DrPlanSummary plan={DRPlan} />
...
`BACKUP_PLANS RESTORE_POINTS CONFORMITE DR_PLANS` ·
...
CARTES_PRODUIT BLOC_PRA BLOC_SOUVERAINETE NIVEAUX_SOUVERAINETE
...
ipsDeLEspace sgDeLEspace lbDeLEspace volumesDeLEspace planById draPlanById
