...
const exploitation = fusion(
  {
    ...
    '/admin/equipe': {
      get: op({
        ...
        paginee: true,
        params: [filtre('equipe', chaine()), filtre('privilegie', booleen()), filtre('revueDue', booleen())],
      ...
      post: op({
        ...
        corps: objet(
          { nom: chaine(), email: chaine(), role: liste(ROLES), equipe: chaine(), privilegie: booleen() },
          ['nom', 'email', 'role', 'equipe'],
        ),
        ok: ref('MembreEquipe'),
        code: 201,
        rbac: 'org.manage',
