...
/**
 * Contour de la Côte d'Ivoire, simplifié à 48 sommets en (longitude, latitude).
 * Assez fidèle pour être reconnaissable : le golfe au sud-est, la pointe nord
 * vers Tengrela, le décrochement de l'est le long du Ghana.
 */
const CONTOUR = [
  [-8.05, 10.05], [-7.7, 10.15], [-7.35, 10.28], [-6.95, 10.35], [-6.65, 10.52],
  [-6.24, 10.74], [-6.05, 10.42], [-5.75, 10.28], [-5.52, 10.32], [-5.2, 10.1],
  [-4.9, 9.9], [-4.6, 9.8], [-4.3, 9.78], [-3.95, 9.9], [-3.6, 9.95],
  [-3.25, 9.85], [-2.95, 9.62], [-2.85, 9.1], [-2.75, 8.55], [-2.62, 8.0],
  [-2.7, 7.55], [-2.92, 7.1], [-3.18, 6.72], [-3.22, 6.35], [-3.0, 6.0],
  [-2.85, 5.6], [-2.95, 5.2], [-3.2, 5.13], [-3.5, 5.08], [-3.74, 5.19],
  [-4.05, 5.24], [-4.4, 5.28], [-4.85, 5.16], [-5.3, 5.0], [-5.8, 4.82],
  [-6.3, 4.65], [-6.75, 4.52], [-7.15, 4.38], [-7.45, 4.42], [-7.55, 4.75],
  [-7.62, 5.15], [-7.85, 5.48], [-8.15, 5.8], [-8.38, 6.25], [-8.48, 6.65],
  [-8.3, 7.0], [-8.18, 7.3], [-8.35, 7.6], [-8.22, 8.0], [-8.08, 8.4],
  [-7.95, 8.75], [-7.9, 9.15], [-7.98, 9.55], [-8.05, 9.85],
]
